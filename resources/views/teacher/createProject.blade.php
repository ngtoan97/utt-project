            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="contact-form">
                        <form action="{{ route('listProject.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label class="control-label col-sm-10" for="fname"><b>{{ trans('message.project.name') }}*</b></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" placeholder="{{ trans('message.project.name') }}" name="name" required>
                                    @if($errors->has('name'))
                                        <p class="text-danger">
                                            {{ $errors->first('name') }}
                                        </p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="number" placeholder="{{ trans('message.project.number') }}" name="number" required>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xl" for="email"><b>{{ trans('message.project.category') }}</b></label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="lname"><b>{{ trans('message.project.description') }}*</b></label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" id="description" placeholder="{{ trans('message.project.description') }}" name="description" required></textarea>
                                </div>
                            ...
                            <div class="form-group">
                                <div class=" col-lg">
                                    <button type="submit" class="btn btn-success col-sm-10">{{ trans('message.project.create') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
